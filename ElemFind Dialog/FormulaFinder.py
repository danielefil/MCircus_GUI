...
#df_output.to_csv(r'C:\Users\df426\Desktop\Part2_2020_7_3_cromoacetato_gallico_1a3_h2o_meoh_1a100_400-2000_NEG.csv')

## WIN PATH
#spectrum_path = '/Users/danielefilippi/Desktop/2020_7_3_cromoacetato_gallico_1a3_h2o_meoh_1a100_400-2000_NEG.csv'
#atoms = [['Cr', 51.9405119, 1, 3], ['O', 15.9949146221, 1, 50], ['C', 12.0, 1, 50], ['H', 1.00783, 1, 10]]
#out = []
#c = FormulaFinder(spectrum_path,atoms, -1, 10, out)
#c.to_csv('/Users/danielefilippi/Desktop/tt.csv')

# lista contenete gli atomi sui quali voglio calcolare i rapporti con il carbonio
#spectrum_path = '/Users/danielefilippi/Desktop/tt.csv'
#ratios = {'DBE': (1,10), 'O': (0.4,3), 'H': (0.5, 3)}
