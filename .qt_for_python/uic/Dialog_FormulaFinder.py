...
class Ui_IsoOptions(object):
    def setupUi(self, IsoOptions):
        ...
        self.dalton_SPbox_F = QtWidgets.QDoubleSpinBox(self.gridLayoutWidget_2)
        self.dalton_SPbox_F.setDecimals(4)
        self.dalton_SPbox_F.setMinimum(0.0005)
        self.dalton_SPbox_F.setSingleStep(0.0001)
        self.dalton_SPbox_F.setObjectName("dalton_SPbox_F")
        self.gridLayout_2.addWidget(self.dalton_SPbox_F, 2, 2, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem1, 1, 1, 1, 1)
        self.dalton_RBtn = QtWidgets.QRadioButton(self.gridLayoutWidget_2)
        self.dalton_RBtn.setObjectName("dalton_RBtn")
        self.gridLayout_2.addWidget(self.dalton_RBtn, 2, 0, 1, 1)
        self.ppm_RBtn = QtWidgets.QRadioButton(self.gridLayoutWidget_2)
        self.ppm_RBtn.setObjectName("ppm_RBtn")
        self.gridLayout_2.addWidget(self.ppm_RBtn, 1, 0, 1, 1)
        self.ppm_SPbox_F = QtWidgets.QSpinBox(self.gridLayoutWidget_2)
        self.ppm_SPbox_F.setProperty("value", 20)
        self.ppm_SPbox_F.setObjectName("ppm_SPbox_F")
        self.gridLayout_2.addWidget(self.ppm_SPbox_F, 1, 2, 1, 1)
    ...
    def retranslateUi(self, IsoOptions):
        ...
        self.dalton_RBtn.setText(_translate("IsoOptions", "Dalton Difference"))
        self.ppm_RBtn.setText(_translate("IsoOptions", "ppm Difference"))
