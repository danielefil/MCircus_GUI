...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gBox_Adducts = QtWidgets.QGroupBox(Dialog)
        self.gBox_Adducts.setGeometry(QtCore.QRect(40, 120, 761, 171))
        self.gBox_Adducts.setObjectName("gBox_Adducts")
        self.Positive_radio = QtWidgets.QRadioButton(self.gBox_Adducts)
        self.Positive_radio.setGeometry(QtCore.QRect(10, 50, 141, 17))
        self.Positive_radio.setObjectName("Positive_radio")
        self.Negative_radio = QtWidgets.QRadioButton(self.gBox_Adducts)
        ...
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.gBox_Adducts)
        ...
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.gBox_Adducts)
        ...
        self.gBoxCharge = QtWidgets.QGroupBox(Dialog)
        self.gBoxCharge.setEnabled(True)
        self.gBoxCharge.setGeometry(QtCore.QRect(700, 140, 90, 70))
        self.gBoxCharge.setAlignment(QtCore.Qt.AlignCenter)
        self.gBoxCharge.setObjectName("gBoxCharge")
        self.charge_number_comboBox = QtWidgets.QComboBox(self.gBoxCharge)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.gBox_Adducts.setTitle(_translate("Dialog", "Adducts selector"))
        ...
        self.gBoxCharge.setTitle(_translate("Dialog", "Max Charge"))
